 ...
 * Remplace l'appel Python (exec) pour des prédictions instantanées.
 */
final class TreePredictor
{
     ...
     *
     * @return array{success: bool, prediction?: array, confidence?: float, top_predictions?: list<array>, error?: string}
     */
