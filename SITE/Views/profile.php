 ...
 * (email, mot de passe). Accès réservé aux utilisateurs authentifiés.
 *
 * Variables attendues :
 * @var array $user Données utilisateur depuis la session
 * @var string $first Prénom extrait
 * @var string $last Nom de famille extrait
 *
 * @package Views
 */
