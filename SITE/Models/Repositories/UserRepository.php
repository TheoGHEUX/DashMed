...
use Core\Interfaces\UserRepositoryInterface; // <-- Ajout de l'import
use PDO;

/**
 * Dépôt Utilisateur (Médecin)
 *
 * Gère toutes les opérations de base de données liées aux comptes médecins.
 * Implémente l'interface UserRepositoryInterface pour respecter l'architecture propre.
 *
